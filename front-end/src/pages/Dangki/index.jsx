            ...
            <div className="min-h-screen bg-gray-100 flex items-center justify-center ">
                <div className="flex flex-col justify-center items-center w-full lg:w-1/2 bg-white py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-md w-full space-y-8">
                        ...
                        <div>
                            <h3 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Đăng kí</h3>
                        </div>
                        ...
                        <form className="mt-8 space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-sm">
                                    Bạn dã có tài khoản?{' '}
                                    <Link className="font-medium text-blue-600 hover:text-blue-500" to="/dangnhap">Đăng nhập</Link>
                                </div>
                            </div>

                            {/* Thông báo lỗi */}
                            <p className="mt-4 text-red-500 text-sm text-center">Mật khẩu không trùng</p>
